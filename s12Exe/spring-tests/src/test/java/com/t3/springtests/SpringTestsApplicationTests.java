...
class SpringTestsApplicationTests {
	...
	@Autowired //faz os construtores referencias de string
	...
	public void mainPageTest() throws Exception {
		assertThat(this.testRestTemplate.getForObject("http://localhost:" + port + "/", String.class)).contains("Pagina Inicial");
	}
